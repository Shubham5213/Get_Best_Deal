...
# favorite product and calls scraper.py and plotter.py as per the requirement.
...
def home():
    if os.path.exists("./config.txt"):
        ...
        info = QLabel("You are all set! you will receive mail when price of your favorite product goes below threshold value")
        info.setStyleSheet(
            "color:'black';"+
            "font-size:20px;"+
            "padding: 0 0 25px 10px;"+
        ...
        #credits
        cred = QLabel("Made with <3 by Shubham")
        cred.setStyleSheet(
            "background:'black';"+
            "color:'white';"+
            "font-weight:bold;"
...
def lastframe():
    if os.path.exists("./config.txt"):
        ...
        #credits
        cred = QLabel("Made with <3 by Shubham-2k21-")
        cred.setStyleSheet(
            "background:'black';"+
            "color:'white';"+
            "font-weight:bold;"
...
def fill_passcode():
    ...
    #credits
    cred = QLabel("Made with <3 by Shubham5213")
    cred.setStyleSheet(
        "background:'black';"+
        "color:'white';"+
        "font-weight:bold;"
...
def fill_mail_id():
    ...
    #mail_id_instruction
    mail_id_box = QLabel("Type your email id on which you would like to get notified")
...
def fill_price_class_box():
    ...
    price_class_box = QLabel("Inspect and paste class name associated with price\n(generally it is '_30jeq3 _16Jk6d'): ")
...
def fill_prod_class():
    ...
    prod_class_box = QLabel("Inspect and paste class name associated with product name (generally it is 'B_NuCI'):")
...
def fill_url():
    ...
    url = QLabel("Paste the url of your favorite product's fl*pk*rt page")
    url.setStyleSheet(
        "color:'blue';"+
        "font-size:24px;"+
        "padding: 0 0 25px 10px;"+
...
def fill_header():
    ...
    header_box = QLabel("Paste the user-agent for your system(google 'what is my user-agent?')")
...
def getStarted():
    ...
    #text
    intro2 = QLabel("Select your favorite item and purchase it at best price!")
